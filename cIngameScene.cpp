...
void cIngameScene::Init()
{
	...
	//m_Exit_Button->Init();
	m_Option_button = new cButton(50, 80, "Option");
	m_Option_button->Init();
	m_goshop = new cButton(550, 100, "GoShop");
	m_goshop->Init();
	m_Notice_button = new cButton(55, 141, "Notice");
...
void cIngameScene::Render()
{
	...
	IMAGE->Render(IMAGE->FindImage(kindC), m_ChangPos, true, RGB(0, 0, 0));
